...
class ParamDefaultValueSpec extends Specification {
  ...
  "GET /test1" should {
    ...
    "map parameter without value" in {
      body(
        routes,
        requestGet("/test1?param1")) must be equalTo "Value of query parameter 'param1' missing"
    }
  }
  ...
  "GET /test3" should {
    ...
    "fail to map parameter with non-numeric value" in {
      body(
        routes,
        requestGet("/test3?param1=value1")) must be equalTo "Invalid number format: 'value1'"
    }
    "map parameter without value" in {
  ...
  "GET /test5" should {
    ...
    "fail on parameter with non-numeric value" in {
      body(
        routes,
        requestGet("/test5?param1=value1")) must be equalTo "Invalid number format: 'value1'"
    }
    "map parameter without value" in {
  ...
  "GET /test7" should {
    ...
    "map parameter with many values" in {
      body(
        routes,
        requestGet(
          "/test7?param1=test123&param1=test456&param1=test889")) must be equalTo "test7:test123,test456,test889"
    }
    "map parameter without value" in {
  ...
  "GET /test8" should {
    ...
    "map parameter with many numeric values" in {
      body(
        routes,
        requestGet("/test8?param1=123&param1=456&param1=789")) must be equalTo "test8:123,456,789"
    }
    "fail to map parameter with many non-numeric values" in {
      body(
        routes,
        requestGet("/test8?param1=abc&param1=def")) must be equalTo "Invalid number format: 'abc'"
    }
    "map parameter without value" in {
  ...
  "GET /test9" should {
    ...
    "fail to map parameter with empty value" in {
      body(
        routes,
        requestGet("/test9?param1=")) must be equalTo "Invalid query parameter: \"param1\" = \"\""
    }
    "fail to map parameter with invalid value" in {
      body(
        routes,
        requestGet(
          "/test9?param1=fail")) must be equalTo "Invalid query parameter: \"param1\" = \"fail\""
    }
  ...
  "GET /test10" should {
    ...
    "fail to map parameter with invalid numeric value" in {
      body(
        routes,
        requestGet(
          "/test10?param1=-4")) must be equalTo "Invalid query parameter: \"param1\" = \"-4\""
    }
    "fail to map parameter with non-numeric value" in {
      body(
        routes,
        requestGet("/test10?param1=value1")) must be equalTo "Invalid number format: 'value1'"
    }
  ...
  "GET /test11" should {
    val routes = new RhoRoutes[IO] {
      GET / "test11" +? param[Option[Int]](
        "param1",
        Some(100),
        (p: Option[Int]) => p != Some(0)) |>> { os: Option[Int] =>
    ...
    "fail to map parameter with invalid numeric value" in {
      body(
        routes,
        requestGet(
          "/test11?param1=0")) must be equalTo "Invalid query parameter: \"param1\" = \"Some(0)\""
    }
    "fail to map parameter with non-numeric value" in {
      body(
        routes,
        requestGet("/test11?param1=value1")) must be equalTo "Invalid number format: 'value1'"
    }
    "map parameter with valid numeric value" in {
  ...
  "GET /test12" should {
    val routes = new RhoRoutes[IO] {
      GET / "test12" +? param[Option[String]](
        "param1",
        Some("default1"),
        (p: Option[String]) => p != Some("fail") && p != Some("")) |>> { os: Option[String] =>
    ...
    "fail to map parameter with empty value" in {
      body(
        routes,
        requestGet(
          "/test12?param1=")) must be equalTo "Invalid query parameter: \"param1\" = \"Some()\""
    }
    "fail to map parameter with invalid value" in {
      body(
        routes,
        requestGet(
          "/test12?param1=fail")) must be equalTo "Invalid query parameter: \"param1\" = \"Some(fail)\""
    }
    "map parameter with valid value" in {
  ...
  "GET /test13" should {
    val routes = new RhoRoutes[IO] {
      GET / "test13" +? param[Seq[String]](
        "param1",
        Seq("a", "b"),
        (p: Seq[String]) => !p.contains("") && !p.contains("z")) |>> { os: Seq[String] =>
  ...
  "GET /test14" should {
    ...
    val routes = new RhoRoutes[IO] {
      GET / "test14" +? param[Seq[Int]](
        "param1",
        Seq(3, 5, 8),
        (p: Seq[Int]) => p != Seq(8, 5, 3)) |>> { os: Seq[Int] => Ok("test14:" + os.mkString(",")) }
    }.toRoutes()
    ...
    "fail to map parameter with one non-numeric value" in {
      body(
        routes,
        requestGet("/test14?param1=test")) must be equalTo "Invalid number format: 'test'"
    }
    "fail to map parameter with many non-numeric values" in {
      body(
        routes,
        requestGet("/test14?param1=abc&param1=def")) must be equalTo "Invalid number format: 'abc'"
    }
